...
const AppHeader: React.FC = () => {
  const { isModePlay, isShowLeftMenu } = useTypedSelector(
    (state) => state.cards
  );
  const { pageAdmin, isAdminPage, isAuthorize } = useTypedSelector(
    (state) => state.auth
  );
  const {
    changeMode,
        ...
        <div className="header-admin">
          <ul>
            <li className="text text-title text-white">
              <NavLink
                to="/admin"
                className={pageAdmin === EPageAdmin.ADMIN_PAGE ? 'choose' : ''}
            ...
            <li className="text text-title text-white">
              <div
                className={
                  pageAdmin === EPageAdmin.ADMIN_WORDS_PAGE ? 'choose' : ''
                }
              >
                Words
              </div>
          ...
          <NavLink
            to="/"
            className="header-logout button button-transparent text-title"
            onClick={leaveAdmin}
          >
            Log out
          </NavLink>
